...
import com.android.launcher3.snail.appicon.IconDecorater;
...
public class LauncherAppState {
    ...
    private IconDecorater mIconDecorater; // add by linmq 2018-7-17
    ...
    private LauncherAppState(Context context) {
        ...
        if (FeatureFlags.SHOW_DISABLE_ICON) {
            FrozenEx.loadLauncherApp(context);
        }
        // add by linmq 2018-7-17
        if (FeatureFlags.CUSTOM_APP_ICON) {
            mIconDecorater = new IconDecorater(context);
        }
    }
