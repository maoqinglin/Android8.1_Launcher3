package com.android.launcher3.snail.folder;
...
import com.android.launcher3.snail.util.FastBlur;
...
public class ImageHelper {
    ...
    public static void blur(Context context, Folder folder, Bitmap bkg) {
        ...
        //modify by linmq 2018-6-26 导致模糊背景以显示一部分
//        canvas.translate(-folderFrame.getLeft() / scaleFactor, -folderFrame.getTop() / scaleFactor);
        ...
        folderFrame.setBackground(drawable);
    }
