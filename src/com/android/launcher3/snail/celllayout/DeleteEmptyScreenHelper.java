...
public class DeleteEmptyScreenHelper {
	...
	public void drawDeleteIcon(Canvas canvas, int scrollX, int scrollY) {
		...
		Drawable deleteIcon = mContext.getResources().getDrawable(
				R.drawable.snail_delete_empty_screen);
		...
		rect.set(left - PADDING_OFFSET, top, view.getMeasuredWidth()
				- PADDING_OFFSET, top + drawableHeight);
		offRect.set(left - TOUCH_OFFSET, top - TOUCH_OFFSET,
				view.getMeasuredWidth() + TOUCH_OFFSET, top + drawableHeight
						+ TOUCH_OFFSET);
