...
public class BgDataModel {
    ...
    public HashSet<ItemInfo> getItemInfoForComponentName(final HashSet<ComponentName> compSet, final UserHandle user) {
        ItemInfoMatcher matcher = ItemInfoMatcher.ofComponents(compSet, user);
        return matcher.filterItemInfos(itemsIdMap);
    }
}
