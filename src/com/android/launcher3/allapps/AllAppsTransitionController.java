...
public class AllAppsTransitionController implements TouchController, SwipeDetector.Listener,
    ...
    public void onDragStart(boolean start) {
        if (!FeatureFlags.SNAIL_PAGE_INDICATOR && mCaretController != null) { // modify bylinmq 2018-6-25
    ...
    public void setProgress(float progress) {
        ...
        if (!FeatureFlags.SNAIL_PAGE_INDICATOR && mCaretController != null) {
    ...
    public void setupViews(AllAppsContainerView appsView, Hotseat hotseat, Workspace workspace) {
        ...
        if (!FeatureFlags.SNAIL_PAGE_INDICATOR && mWorkspace.getPageIndicator() != null) { // modify by linmq 2018-6-25
