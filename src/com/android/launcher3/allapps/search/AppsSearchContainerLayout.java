...
public class AppsSearchContainerLayout extends FrameLayout
    ...
    public void initialize(
        ...
        mApps = appsList;
        mAppsRecyclerView = recyclerView;  // 展示搜索结果的RecyclerView
        mAppsRecyclerView.addOnScrollListener(mElevationController);
        mAdapter = (AllAppsGridAdapter) mAppsRecyclerView.getAdapter();
        mSearchBarController.initialize(
                new DefaultAppSearchAlgorithm(appsList.getApps()), mSearchInput, mLauncher, this); // mSearchBarController为搜索控制中心，DefaultAppSearchAlgorithm执行搜索，然后回调
    }
    ...
    public void onSearchResult(String query, ArrayList<ComponentKey> apps) {
        if (apps != null) {
            ...
            mAdapter.setSearchStart(true); // add by linmq 2018-7-22
        }
    }

    @Override
    public void clearSearchResult() {
        mAdapter.setSearchStart(false); // add by linmq 2018-7-22
