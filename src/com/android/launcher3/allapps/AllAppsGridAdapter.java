...
public class AllAppsGridAdapter extends RecyclerView.Adapter<AllAppsGridAdapter.ViewHolder> {
    ...
    boolean mSearchStart;
    public void setSearchStart(boolean searchStart){
        mSearchStart = searchStart;
    }
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        switch (holder.getItemViewType()) {
            case VIEW_TYPE_ICON:
            case VIEW_TYPE_PREDICTION_ICON:
                if (FeatureFlags.DISABLE_ALL_APPS && holder.getItemViewType() == VIEW_TYPE_ICON) { // add by linmq 2018-7-20
                    holder.itemView.setVisibility(mSearchStart ? View.VISIBLE : View.INVISIBLE);
                }
