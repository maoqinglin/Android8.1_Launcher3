...
import com.android.launcher3.snail.celllayout.DeleteEmptyScreenHelper;
...
public class CellLayout extends ViewGroup implements BubbleTextShadowHandler {
    ...
    public CellLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        if (FeatureFlags.ADD_OR_DELETE_CELLLAYOUT) { // add bylinmq 2018-6-26
    ...
    public boolean onTouchEvent(MotionEvent ev) {
        ...
        if (FeatureFlags.ADD_OR_DELETE_CELLLAYOUT && mEmptyScreenHelper != null) {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        mTouchFeedbackView.measure(
                ...
                MeasureSpec.makeMeasureSpec(mCellHeight + mTouchFeedbackView.getExtraSize(),
                        MeasureSpec.EXACTLY));
        if (FeatureFlags.ADD_CUSTOM_PAGE && this instanceof CustomPage) {
    ...
    */
    ...
    public int[] performReorder(int pixelX, int pixelY, int minSpanX, int minSpanY, int spanX, int spanY,
    ...
    // add by linmq 2017-3-14
    private DeleteEmptyScreenHelper mEmptyScreenHelper;
