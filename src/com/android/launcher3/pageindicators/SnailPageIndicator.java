...
public class SnailPageIndicator extends PageIndicator {
    ...
    public SnailPageIndicator(Context context) {
        this(context, null);
    }

    public SnailPageIndicator(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public SnailPageIndicator(Context context, AttributeSet attrs, int defStyle) {
...
//        m.setMarkerDrawables(marker.activeId, marker.inactiveId);
    ...
    //modify by linmq 2017-6-7 修改访问修饰符为public
...
//            m.setMarkerDrawables(marker.activeId, marker.inactiveId);
            ...
            Log.e(TAG, "index = " + index + " is not illegal");
        }
    }
